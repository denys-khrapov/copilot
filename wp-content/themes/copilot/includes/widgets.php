...
class Widget_Recent_Posts_From_Category extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array(
			...
			'description' => __( 'The most recent posts from specific category on your site', 'wpbase' ),
		);
		parent::__construct( 'recent-posts-from-category', __( 'Recent Posts From Specific Category', 'wpbase' ), $widget_ops );
	...
	function widget( $args, $instance ) {
		...
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'Recent Posts', 'wpbase' ) : $instance['title'], $instance, $this->id_base );
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>">
				<?php _e( 'Number of posts to show:', 'wpbase' ); ?>
			</label>
